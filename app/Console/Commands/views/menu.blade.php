...
<li class="nav-item">   
    ...
    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1 collapsed"
            href="#module-id" role="button" data-bs-toggle="collapse" aria-expanded="false"
            ...
            <div class="d-flex align-items-center">
                <div class="dropdown-indicator-icon"><svg class="svg-inline--fa fa-caret-right"
                    ...
                    </svg></span><span class="nav-link-text">Quản lý module</span>
            </div>
        </a>
        <div class="parent-wrapper label-1">
            <ul class="nav parent collapse {{$active === 'module' || $active === 'module.create'?'show' : ''}}" data-bs-parent="#navbarVerticalCollapse" id="module-id"
                style="">
                <li class="collapsed-nav-item-title d-none">Quản lý module</li>
                <li class="nav-item"><a class="nav-link {{$active === 'module'?'active' : ''}}" href="{{route('admin.module.index')}}"
                        data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span
                                class="nav-link-text">Danh sách module</span></div>
                    </a><!-- more inner pages--> 
                </li>
                <li class="nav-item"><a class="nav-link {{$active === 'module.create'?'active' : ''}}" href="{{route('admin.module.add')}}"
                        data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span
                                class="nav-link-text">Thêm module</span></div>
                    </a><!-- more inner pages-->
                </li>
