...
<li class="nav-item">   
    ...
    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1 collapsed"
        ...
        <div class="parent-wrapper label-1">
            <ul class="nav parent collapse {{$active === 'groups' || $active === 'groups.create'?'show' : ''}}" data-bs-parent="#navbarVerticalCollapse" id="icons"
                style="">
                <li class="collapsed-nav-item-title d-none">Quản lý nhóm</li>
                <li class="nav-item"><a class="nav-link {{$active === 'groups'?'active' : ''}}" href="{{route('admin.groups.index')}}"
                        data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span
                                class="nav-link-text">Danh sách nhóm</span></div>
                    </a><!-- more inner pages--> 
                </li>
                <li class="nav-item"><a class="nav-link {{$active === 'groups.create'?'active' : ''}}" href="{{route('admin.groups.add')}}"
                        data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span
                                class="nav-link-text">Thêm nhóm</span></div>
                    </a><!-- more inner pages-->
                </li>
