...
<li class="nav-item">   
    ...
    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1 collapsed"
            href="#website-id" role="button" data-bs-toggle="collapse" aria-expanded="false"
            aria-controls="website-id">
            <div class="d-flex align-items-center">
                <div class="dropdown-indicator-icon"><svg class="svg-inline--fa fa-caret-right"
                    ...
                    </svg></span><span class="nav-link-text">Quản lý website</span>
            </div>
        </a>
        <div class="parent-wrapper label-1">
            <ul class="nav parent collapse {{$active === 'website' || $active === 'website.create'?'show' : ''}}" data-bs-parent="#navbarVerticalCollapse" id="website-id"
                style="">
                <li class="collapsed-nav-item-title d-none">Quản lý website</li>
                <li class="nav-item"><a class="nav-link {{$active === 'website'?'active' : ''}}" href="{{route('admin.website.index')}}"
                        data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span
                                class="nav-link-text">Danh sách website</span></div>
                    </a><!-- more inner pages--> 
                </li>
                <li class="nav-item"><a class="nav-link {{$active === 'website.create'?'active' : ''}}" href="{{route('admin.website.add')}}"
                        data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span
                                class="nav-link-text">Thêm website</span></div>
                    </a><!-- more inner pages-->
                </li>
